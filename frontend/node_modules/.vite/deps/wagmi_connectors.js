...
import {
  ...
  injected,
  mock
} from "./chunk-UZSG2NKI.js";
import "./chunk-TTNRIITN.js";
import "./chunk-Z5ZQKJGS.js";
import "./chunk-ANJCMEYS.js";
import {
  import_index
} from "./chunk-BZVR2A3R.js";
import {
  require_browser,
  require_fast_safe_stringify
} from "./chunk-G3KMQNHP.js";
import "./chunk-ZO77EUZE.js";
import {
  withRetry,
  withTimeout
} from "./chunk-5EAAADFD.js";
import "./chunk-VUVWP5LB.js";
import "./chunk-GBCVK2OL.js";
import "./chunk-YL5B7ZW7.js";
import {
  arbitrum,
  arbitrumSepolia,
  base,
  ...
  polygonAmoy,
  sepolia
} from "./chunk-YZICMSVE.js";
import "./chunk-4KYM5L35.js";
import "./chunk-VGOUJ53D.js";
import {
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createBaseAccountSDK } = await import("./dist-ZM4EGF24.js");
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createCoinbaseWalletSDK } = await import("./dist-LSNKORWB.js");
    ...
    async getProvider() {
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-TIZKZTOP.js");
    ...
    async getProvider() {
      async function initProvider() {
        const MetaMaskSDK = await (async () => {
          const { default: SDK } = await import("./metamask-sdk-HPW2XJTC.js");
          if (typeof SDK !== "function" && typeof SDK.default === "function")
            return SDK.default;
          return SDK;
        })();
  ...
  return createConnector((wagmiConfig) => {
    ...
    return {
      ...
      async getPortoInstance() {
        porto_promise ??= (async () => {
          const { Porto } = await import("./dist-PEXQHK3X.js");
          return Porto.create({
            ...parameters,
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-XDNG4JTU.js");
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await import("./dist-C6ZZSPJY.js");
    ...
    async getProvider({ chainId } = {}) {
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-CPA6OW7N.js");
